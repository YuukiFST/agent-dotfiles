...
Run this matrix before outputting code. This is the last filter. Section numbers in parentheses refer to the original section headings, now inside the sibling `references/` files mapped in SKILL.md.

**THIS IS NOT OPTIONAL. Run every box. If any box fails, the output is not done.**

- [ ] **Brief inference** declared (Section 0.B one-liner)?
- [ ] **Dial values** explicit and reasoned from the brief, not silently using baseline?
- [ ] **Design system** chosen from `references/design-systems.md` if applicable, or aesthetic labeled honestly?
- [ ] **Redesign mode** detected and audit performed (if applicable, `references/redesign.md`)?
- [ ] **ZERO em-dashes (`—`) anywhere on the page.** Headlines, eyebrows, pills, body, quotes, attribution, captions, buttons, alt text. Zero. (`references/ai-tells.md` 9.G - non-negotiable.)
- [ ] **Page Theme Lock**: ONE theme (light, dark, or auto) for the whole page. No section flips to inverted mode mid-page (4.11)?
- [ ] **Color Consistency Lock**: one accent color used identically across all sections (4.2)?
...
- [ ] **Long lists use the right UI component** (not default `<ul>` with `divide-y` for > 5 items - see `references/design-directives.md` 4.9 alternatives)?
...
- [ ] **GSAP sticky-stack / horizontal-pan** implemented per the canonical skeletons in `references/motion.md` (`start: "top top"`, `pin: true`, correct scrub)?
