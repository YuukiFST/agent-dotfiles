...
| **Debugging & design** | `diagnosing-bugs`, `codebase-design`, `domain-modeling`, `prototype` (browser work: `agent-browser`; `webapp-testing` archived in `stacks/webapp-testing/`) |
