...
**If subagent-driven chosen:** dispatch subagents per task with review between tasks.

**If inline execution chosen:** load `executing-plans` and follow batch execution with checkpoints.
