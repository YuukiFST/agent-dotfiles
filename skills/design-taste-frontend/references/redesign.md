> Extracted from SKILL.md (original section numbering preserved). Cross-references to sections in other files resolve via the reference map in SKILL.md: S2+Appendices=design-systems.md, S3=architecture.md, S4=design-directives.md, S5=motion.md, S6-8=foundations.md, S9=ai-tells.md, S10=vocabulary.md, S11=redesign.md, S12=block-library.md, S13-14 inline in SKILL.md.
