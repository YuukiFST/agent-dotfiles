---
name: improve
description: Survey a codebase as a senior advisor and produce prioritized, self-contained plans for OTHER agents to execute. Strictly read-only — never implements or fixes anything itself. Use for codebase audits, improvement opportunities (bugs, security, performance, tests, tech debt, DX), roadmap/feature suggestions, or handoff plans.
license: MIT
metadata:
  author: shadcn
  version: "1.0.0"
