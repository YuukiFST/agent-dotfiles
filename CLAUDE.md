...
- **Building a screen/component or improving how an existing one looks and feels** → skill `ui-craft` (router over the design references in `~/.claude/ui-refs/`; never read those references directly).
