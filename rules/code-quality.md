...
Token cost, tool-call latency, output quality — technical constraints, not style opinions. Applies to any non-trivial code writing, not just improvement passes.
